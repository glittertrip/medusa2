...
def creator(screen):
    ...
    credit_list = ["CREDITS - Medusa"," ","Alex- Literally Sat there and made bad jokes the whole time, put music","Emma Hartman- showed me minecraft parodies, Dialogue Box Engineer", "Rita- Coded entrance and exit portals. She draws better than me", "Yewon Oh!- Movement God, Camera Cod, kept us on task or whatev", "Special thanks to Mimi and google.com ~ "]
